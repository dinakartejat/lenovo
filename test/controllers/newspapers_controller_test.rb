...
class NewspapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newspaper" do
    assert_difference('Newspaper.count') do
      post newspapers_url, params: { newspaper: { bundleofpapers: @newspaper.bundleofpapers, name: @newspaper.name, noofpages: @newspaper.noofpages } }
    end
  ...
  test "should update newspaper" do
    patch newspaper_url(@newspaper), params: { newspaper: { bundleofpapers: @newspaper.bundleofpapers, name: @newspaper.name, noofpages: @newspaper.noofpages } }
